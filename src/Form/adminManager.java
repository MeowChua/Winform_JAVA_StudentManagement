...
import static Technical.ReadEcalAdmin.readExcel;
...
public class adminManager extends javax.swing.JFrame {
    ...
    public void showTable() {
        ...
        while(var1.hasNext()) {
            admin s = (admin)var1.next();
            this.model.addRow(new Object[]{s.getID(),s.getTenAD(),s.getDOB(),s.getADDRESS(),s.getEMAIL(),s.getSDT()});
           
        }

    }
    public void showResult() {
        admin s = (admin)this.list.get(this.list.size() - 1);
        this.model.addRow(new Object[]{s.getID(),s.getTenAD(),s.getDOB(),s.getADDRESS(),s.getEMAIL(),s.getSDT()});
    }
    public adminManager() {
         initComponents();
        this.setLocationRelativeTo((Component)null);
        this.list = (new connectAdmin()).getListTeacher();
        this.model = (DefaultTableModel)this.jTable1.getModel();
        this.model.setColumnIdentifiers(new Object[]{ "ID", "FULLNAME", "DOB", "ADDRESS", "EMAIL", "SDT"});
        this.showTable();
    }
    ...
    public void export(JTable jtable) throws IOException {
        ...
        try {
            ...
            XSSFSheet sheet = wb.createSheet("Thông Tin ADMIN");
    ...
    private void jLabel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel1MouseClicked
        ...
        connectAdmin dat=new connectAdmin();
        boolean flag=false;
    ...
    private void jLabel3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel3MouseClicked
        ...
        for (admin book : books) {
            if ((new connectAdmin()).addTeacher(book)) {
                this.list.add(book);
            } else {
    ...
    private void jLabel11MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel11MouseClicked
        ...
        if(jTable1.getSelectedRowCount()==1){
            ...
            tblModel.setValueAt(mark,jTable1.getSelectedRow(),4);
        ...
        if(flag==true){
            connectAdmin d=new connectAdmin();
            d.update(std);
        }
    ...
    private void jLabel13MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel13MouseClicked
        ...
        s.setTenAD(this.txtNAME.getText());
        s.setSDT(this.txtPHONE.getText());
        s.setDOB(this.txtDOB.getText());

        if ((new connectAdmin()).addTeacher(s)) {
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        String Email = tblModel.getValueAt(jTable1.getSelectedRow(),4).toString();
        txtID.setText(id);
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        Collections.sort(list, new Comparator<admin>() {
            @Override
            public int compare(admin sv1, admin sv2) {
