...
import static Technical.ReadEcalSubject.readExcel;
...
public class SubjectManager extends javax.swing.JFrame {
    ...
    public void showTable() {
        ...
        while(var1.hasNext()) {
            SB s = (SB)var1.next();
            this.model.addRow(new Object[]{s.getMaMH(), s.getTenMH(), s.getNXB(), s.getKhoa()});
           
        }

    }
    public void showResult() {
        SB s = (SB)this.list.get(this.list.size() - 1);
        this.model.addRow(new Object[]{s.getMaMH(), s.getTenMH(), s.getNXB(), s.getKhoa()});
    }
    public SubjectManager() {
        initComponents();
        this.setLocationRelativeTo((Component)null);
        this.list = (new connectSubject()).getListTeacher();
        this.model = (DefaultTableModel)this.jTable1.getModel();
        this.model.setColumnIdentifiers(new Object[]{ "ID_MH", "NAME SUBJECT", "AUTHOR", "KHOA"});
        this.showTable();
    }
    /**
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID_MH", "NAME SUBJECT", "AUTHOR", "YEAR"
            }
        ) {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 377, 1110, 330));

        jLabel15.setFont(new java.awt.Font("Tahoma", 1, 20)); // NOI18N
        jLabel15.setText("ID_MH: ");

        jLabel16.setFont(new java.awt.Font("Tahoma", 1, 20)); // NOI18N
        jLabel16.setText("NAME SUBJECT");
        ...
        getContentPane().add(jPanel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 200, 580, 170));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addContainerGap())
            .addComponent(jLabel23, javax.swing.GroupLayout.DEFAULT_SIZE, 520, Short.MAX_VALUE)
        );
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(960, 120, 520, 250));
        ...
        jLabel26.setText("SUBJECT MANAGER");
        getContentPane().add(jLabel26, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 130, 590, 59));
    ...
    private void jLabel3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel3MouseClicked
        final String excelFilePath ="C:\\Users\\WIN 10\\Documents\\MonHoc.xlsx";
        List<SB> books = null;
        try {
        ...
        for (SB book : books) {
            if ((new connectSubject()).addTeacher(book)) {
                this.list.add(book);
            } else {
    ...
    private void jLabel11MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel11MouseClicked
        ...
        if(flag==true){
            connectSubject d=new connectSubject();
            d.update(std);
        }
    ...
    private void jLabel13MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel13MouseClicked
        SB s = new SB();
        s.setKhoa(this.txtADDRESS.getText());

        s.setMaMH(this.txtIDGV.getText());
        s.setTenMH(this.txtNAME.getText());

        s.setNXB(this.txtDOB.getText());

        if ((new connectSubject()).addTeacher(s)) {
...
public void export(JTable jtable) throws IOException {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        DefaultTableModel tbModel =(DefaultTableModel)jTable1.getModel();
        String id=txtIDGV.getText();
        connectSubject dat=new connectSubject();
        boolean flag=false;
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
       ...
       this.list = (new connectSubject()).getListTeacher();
        Collections.sort(list, new Comparator<SB>() {
            @Override
            public int compare(SB sv1, SB sv2) {
