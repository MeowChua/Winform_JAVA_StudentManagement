...
import static Technical.ReadEcalStudent.readExcel;
...
public class StudentManager extends javax.swing.JFrame {
   ...
   private ArrayList<SV> list;
    ...
    public void showTable() {
        ...
        while(var1.hasNext()) {
            SV s = (SV)var1.next();
            this.model.addRow(new Object[]{s.getMaMH(), s.getTenMH(), s.getDob(), s.getAddress(), s.getSDT(), s.getEmail()});
           
        }

    }
    public void showResult() {
        SV s = (SV)this.list.get(this.list.size() - 1);
        this.model.addRow(new Object[]{s.getMaMH(), s.getTenMH(), s.getDob(), s.getAddress(), s.getSDT(), s.getEmail()});
    }
    public StudentManager() {
        initComponents();
        this.setLocationRelativeTo((Component)null);
        this.list = (new connectStudent()).getListTeacher();
        this.model = (DefaultTableModel)this.jTable1.getModel();
        this.model.setColumnIdentifiers(new Object[]{ "ID_SV", "FULLNAME", "DOB", "ADDRESS", "SDT", "EMAIL"});
        this.showTable();
    }
    ...
    private void initComponents() {
        ...
        jLabel24.setIcon(new javax.swing.ImageIcon("C:\\Users\\WIN 10\\Downloads\\book (1).png")); // NOI18N
        ...
        getContentPane().add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 0, -1, -1));

        jLabel15.setFont(new java.awt.Font("Tahoma", 1, 20)); // NOI18N
        jLabel15.setText("ID_SV: ");
        ...
        getContentPane().add(jPanel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 150, -1, 270));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID_GV", "FULLNAME", "DOB", "ADDRESS", "NUMBERPHONE", "EMAIL"
            }
        ) {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 447, 1110, 260));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jLabel23, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 500, Short.MAX_VALUE)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGap(20, 20, 20)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(960, 120, 520, 320));
    ...
    private void jLabel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel1MouseClicked
        ...
        connectStudent dat=new connectStudent();
        boolean flag=false;
  ...
  final String excelFilePath ="C:\\Users\\WIN 10\\Documents\\ThongTinGiaoVien.xlsx";
        List<SV> books = null;
        try {
        ...
        for (SV book : books) {
            if ((new connectStudent()).addTeacher(book)) {
            this.list.add(book);
        } else {
    ...
    private void jLabel11MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel11MouseClicked
        ...
        if(jTable1.getSelectedRowCount()==1){
            ...
            tblModel.setValueAt(mark,jTable1.getSelectedRow(),5);
        ...
        if(flag==true){
            connectStudent d=new connectStudent();
            d.update(std);
        }
    ...
    private void jLabel13MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel13MouseClicked
        ...
        s.setMaMH(this.txtIDGV.getText());
        s.setTenMH(this.txtNAME.getText());
        s.setSDT(this.txtPHONE.getText());
        s.setDob(this.txtDOB.getText());

        if ((new connectStudent()).addTeacher(s)) {
...
public void export(JTable jtable) throws IOException {
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        String SDT = tblModel.getValueAt(jTable1.getSelectedRow(),4).toString();
   ...
   SV s = new SV();
        ...
        if ((new connectStudent()).addTeacher(s)) {
            ...
            JOptionPane.showMessageDialog(this.rootPane, "Unsuccessful!");
        }
       ...
       this.list = (new connectStudent()).getListTeacher();
        Collections.sort(list, new Comparator<SV>() {
            ...
            public int compare(SV sv1, SV sv2) {
                return (sv1.getMaMH().compareTo(sv2.getMaMH()));
